...
envsubst '$SMTP_RELAY_HOST $SMTP_RELAY_PORT $SMTP_RELAY_TLS_SECURITY_LEVEL $SMTP_RELAY_MYHOSTNAME $SMTP_RELAY_MYORIGIN $SMTP_RELAY_MYDESTINATION $SMTP_RELAY_MYNETWORKS $SMTP_RELAY_INET_INTERFACES $SMTP_RELAY_TLS_CA_FILE' \
