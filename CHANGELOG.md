...
## v1.1.0 pathocore-web - "Olive Realgar Camel" 2026/07/23
...
- [#36](https://github.com/BIPLAT-CIBERINFEC/pathocore-web/pull/36) Adapt API runtime settings and SQL seed cleanup for orchestrated test installs.
